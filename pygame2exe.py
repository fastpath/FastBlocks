...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "fastblocks.py"
 
        #Name of program
        self.project_name = "FastBlocks"
        ...
        #Auhor of program
        self.author_name = "Erik Wittkorn"
        self.author_email = "erik.wittkorn@googlemail.com"
        self.copyright = "Copyright (c) 2011 Me."
 
        #Description
        self.project_description = "First approach to pygame with a Tetris game"
        ...
        self.extra_scripts = ["gamelogic","inputtext","text"]
 
        #Zip file name (None will bundle files in exe instead of zip file)
        self.zipfile_name = None
 
        #Dist directory
        self.dist_dir ='dist/Windows'
    ...
    def run(self):
        ...
        if self.icon_file == None:
            ...
            self.icon_file = os.path.join(path, 'icon.ico')
